...
auc, dfout = auc_svr(dfc)
dfout.to_csv("%s/%s_svr.csv"%(options.output, options.drug), index=False)
with open("%s/%s_svr.txt"%(options.output, options.drug),"w") as outFile:
